...
| CI service account / WIF pool/provider | `supply-chain-ci` / `supply-chain-github-pool` / `github-provider` | GitHub OIDC to GAR | No | No material direct cost | Declared in Terraform prod root; dedicated to canonical repo |
